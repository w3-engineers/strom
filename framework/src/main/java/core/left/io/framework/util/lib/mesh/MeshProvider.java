package core.left.io.framework.util.lib.mesh;
...
public class MeshProvider implements MeshStateListener {
    ...
    public void start(Context context) {
        ...
        mAndroidMeshManager = TextUtils.isEmpty(mMeshConfig.mSsid) ?
                AndroidMeshManager.getInstance(context, this) :
                AndroidMeshManager.getInstance(context, this, mMeshConfig.mSsid);
